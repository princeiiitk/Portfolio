      ...
      <div className="flex flex-col items-center bg-gray-900 min-h-screen text-white">
            ...
            <div className=" flex-col md:flex-row items-center justify-center md:justify-start gap-4 mt-4 hidden md:flex">
              {["Skills", "Projects", "About", "Contact", "Education"].map((text) => (
                <button
                  ...
                  key={text}
                  className="w-full md:w-auto px-4 py-2 bg-yellow-500 rounded-lg font-semibold transition-colors duration-300 ease-in-out hover:bg-yellow-600 shadow-md transform hover:scale-105 hover:-translate-y-1"
                >
                  {text}
                </button>
              ))}
        ...
        <div className="flex flex-col md:flex-row items-center justify-between w-full max-w-6xl mt-12 p-6 md:p-8 bg-gray-800 shadow-xl rounded-lg transition-transform duration-700 ease-in-out hover:scale-105 mx-4 animate-slide-up">
          ...
          <div className="md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            ...
            <button onClick={HandleShowcase} className="mt-4 w-full md:w-auto px-4 py-2 bg-yellow-500 rounded-lg font-semibold transition-colors duration-300 ease-in-out hover:bg-yellow-600 shadow-md transform hover:scale-105 hover:-translate-y-1">
              Showcase
            </button>
          </div>
